<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_login.aspx.cs" Inherits="Library.student.student_login" %>
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form id="f1" runat="server">
                        ...
                        <asp:Button ID="b1" runat="server" Text="Sign In" CssClass="btn btn-success btn-flat m-b-30 m-t-30" OnClick="b1_Click"></asp:Button><br />
                        <center><a href="student_registration.aspx" style="color:darkblue">Register Now</a></center>
